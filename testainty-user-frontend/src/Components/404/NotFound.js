    ...
    <div className='h-screen'>
      <nav className='w-full shadow-md z-0 bg-white'>
        <div className="flex justify-between items-center py-1 px-4">
          <Link to="/"><img src={images.LOGO} className='w-24 lg:w-44 xl:w-44' alt='Logo' /></Link>
          <Link to="/"><button className='text-xs lg:text-sm xl:text-sm bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full '>Go Back Home</button></Link>
        </div>
      </nav>
